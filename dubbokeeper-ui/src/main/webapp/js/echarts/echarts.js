...
!function (e) {
    ...
    s.version = "2.2.4", s.dependencies = {zrender: "2.0.9"}, s.init = function (t, n) {
        var a = e("zrender");
    ...
    return t.prototype = {
        type: a.CHART_TYPE_ISLAND, _combine: function (t, i) {
            ...
            var t = o.get(e, "name"), i = o.get(e, "value"),
                ...
                r = this.getFont(this.option.island.textStyle), s = {
    ...
    return t.prototype = {
        type: o.COMPONENT_TYPE_TITLE, _buildShape: function () {
            ...
            var V = {
                ...
                z: this.getZBase(),
                style: {
                    y: c + p, color: this.titleOption.subtextStyle.color, text: a, textFont: h,
                    textBaseline: "bottom"
                },
    ...
    var o = e("./config"), r = e("./tool/env"), s = e("./tool/event"), l = e("./tool/util"), h = e("./tool/vector"),
        ...
        u = {
            resize: function (e) {
                ...
                e = this._zrenderEventFixed(e);
                var t = e.wheelDelta || -e.detail, i = t > 0 ? 1.1 : 1 / 1.1, n = !1, a = this._mouseX,
                    o = this._mouseY;
